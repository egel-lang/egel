...
public:
    ...
    void visit_decl_value(const Position& p, const AstPtr& l, const AstPtr& r) override {
        visit(l);
    }
...
public:
    ...
    AstPtr rewrite_decl_value(const Position& p, const AstPtr& l, const AstPtr& r) override {
        set_identify_state(STATE_IDENTIFY_USE);
        auto l0 = rewrite(l);
        auto r0 = rewrite(r);
