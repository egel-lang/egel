...
DOCSTRING("FFI::library - opaque library object");
    ...
    VMObjectPtr function(const icu::UnicodeString& s) {
        ...
        oo.push_back(
            machine()->create_integer(reinterpret_cast<long long>(ptr)));
...
DOCSTRING("FFI::call f r x - call a function");
    ...
    bool is_arg_type(const VMObjectPtr& o) const {
        if (machine()->is_array(o) && (machine()->array_size(o) == 2)) {
            ...
            return ((machine()->is_data_text(o0, c_bool) &&
                     machine()->is_bool(o1)) ||
                    (machine()->is_data_text(o0, c_char) &&
                     machine()->is_char(o1)) ||
                    // (machine()->is_data_text(o0, c_wchar) &&
                    // machine()->is_char(o1))  ||
                    (machine()->is_data_text(o0, c_byte) &&
                     machine()->is_integer(o1)) ||
                    (machine()->is_data_text(o0, c_ubyte) &&
                     machine()->is_integer(o1)) ||
                    (machine()->is_data_text(o0, c_short) &&
                     machine()->is_integer(o1)) ||
                    (machine()->is_data_text(o0, c_ushort) &&
                     machine()->is_integer(o1)) ||
                    (machine()->is_data_text(o0, c_int) &&
                     machine()->is_integer(o1)) ||
                    (machine()->is_data_text(o0, c_uint) &&
                     machine()->is_integer(o1)) ||
                    (machine()->is_data_text(o0, c_long) &&
                     machine()->is_integer(o1)) ||
                    (machine()->is_data_text(o0, c_ulong) &&
                     machine()->is_integer(o1)) ||
                    (machine()->is_data_text(o0, c_longlong) &&
                     machine()->is_integer(o1)) ||
                    (machine()->is_data_text(o0, c_ulonglong) &&
                     machine()->is_integer(o1)) ||
                    (machine()->is_data_text(o0, c_size_t) &&
                     machine()->is_integer(o1)) ||
                    (machine()->is_data_text(o0, c_ssize_t) &&
                     machine()->is_integer(o1)) ||
                    (machine()->is_data_text(o0, c_time_t) &&
                     machine()->is_integer(o1)) ||
                    (machine()->is_data_text(o0, c_float) &&
                     machine()->is_float(o1)) ||
                    (machine()->is_data_text(o0, c_double) &&
                     machine()->is_float(o1)) ||
                    (machine()->is_data_text(o0, c_longdouble) &&
                     machine()->is_float(o1)) ||
                    (machine()->is_data_text(o0, c_char_p) &&
                     (machine()->is_text(o1) || machine()->is_none(o1))) ||
                    // (machine()->is_data_text(o0, c_wchar_p) &&
                    // (machine()->is_text(o1) || machine()->is_none(o1))) ||
                    (machine()->is_data_text(o0, c_void_p) &&
                     (machine()->is_integer(o1) || machine()->is_none(o1))));
        } else {
            return false;
        }
    }
    ...
    void* to_ffi_value(const VMObjectPtr& o) const {
        if (machine()->is_array(o) && (machine()->array_size(o) == 2)) {
            ...
            if (machine()->is_data_text(o0, c_bool)) {
                ...
                *(static_cast<char*>(p)) =
                    static_cast<char>(machine()->get_char(o1));
                return p;
                /*
                ...
                */
                ...
                void* p = malloc(sizeof(char));
                *(static_cast<char*>(p)) =
                    static_cast<char>(machine()->get_integer(o1));
                return p;
                ...
                */
                ...
                if (machine()->is_none(o1)) {
                    ...
                    *(static_cast<void**>(p)) =
                        reinterpret_cast<void*>(machine()->get_integer(o1));
                    return p;
                }
            } else {
    ...
    VMObjectPtr from_ffi_value(const VMObjectPtr& t, void* v) const {
        ...
        if (machine()->is_data_text(t, c_void)) {
            ...
            if (p == nullptr) {
                ...
                oo.push_back(
                    machine()->create_integer(reinterpret_cast<vm_int_t>(p)));
            }
        } else {
            PANIC("ffi type expected");
        }
    ...
    sizeof(long), it
             ...
             // Specify the data type of each argument. Available types are
    defined
             // in <ffi/ffi.h>.
    ...
    */
    ...
    VMObjectPtr apply(const VMObjectPtr& arg0, const VMObjectPtr& arg1,
        ...
        if (is_function_ptr(arg0) && is_return_type(arg1) &&
            machine()->is_list(arg2)) {
            ...
            if ((status = ffi_prep_cif(&cif, FFI_DEFAULT_ABI, n, ret_type,
                                       arg_types)) != FFI_OK) {
            ...
            // std::cerr << "ffi_call " << p << "(n = " << n << ")" <<
            // std::endl;
            ffi_call(&cif, FFI_FN(p), &result, arg_values);

            auto r = from_ffi_value(arg1, &result);

            // char* has copying semantics both in and out but prevent double
            // free
            char* cout = nullptr;
            ...
            for (size_t i = 0; i < n; i++) {
                if (machine()->is_data_text(machine()->array_get(oo[i], 0),
                                            c_char_p)) {
...
DOCSTRING("FFI::peek p n t - peek a number of bytes beyond for value of type");
    VMObjectPtr apply(const VMObjectPtr& arg0, const VMObjectPtr& arg1,
        ...
        if (machine()->is_array(arg0) && (machine()->array_size(arg0) == 2) &&
            machine()->is_data_text(machine()->array_get(arg0, 0), c_void_p) &&
            machine()->is_integer(machine()->array_get(arg0, 1)) &&
            machine()->is_integer(arg1) && machine()->is_data(arg2)) {
            ...
            if (machine()->is_data_text(arg2, c_bool)) {
                ...
                oo.push_back(
                    machine()->create_integer(static_cast<vm_int_t>(b)));
                ...
                oo.push_back(
                    machine()->create_integer(static_cast<vm_int_t>(n)));
                ...
                oo.push_back(
                    machine()->create_float(static_cast<vm_float_t>(f)));
                ...
                if (p == nullptr) {
                    ...
                    oo.push_back(machine()->create_integer(
                        reinterpret_cast<vm_int_t>(p)));
                }
            } else {
                PANIC("ffi type expected");
            }
...
DOCSTRING("FFI::poke p n v - poke a value a number of bytes beyond pointer");
    VMObjectPtr apply(const VMObjectPtr& arg0, const VMObjectPtr& arg1,
        ...
        if (machine()->is_array(arg0) && (machine()->array_size(arg0) == 2) &&
            machine()->is_data_text(machine()->array_get(arg0, 0), c_void_p) &&
            machine()->is_integer(machine()->array_get(arg0, 1)) &&
            machine()->is_integer(arg1) && machine()->is_array(arg2) &&
            ...
            if (machine()->is_data_text(o0, c_bool)) {
                ...
                *(reinterpret_cast<long double*>(ptr)) =
                    static_cast<long double>(machine()->get_float(o1));
            } else if (machine()->is_data_text(o0, c_char_p)) {
                if (machine()->is_none(o1)) {
